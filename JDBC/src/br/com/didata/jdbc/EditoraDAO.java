...
public class EditoraDAO {
	...
	public void adiciona(Fornecedor editora) {
	...
	public void altera(Fornecedor editora) {
	...
	public void remove(Fornecedor editora) {
	...
	public List<Fornecedor> listaEditora() {
		String sql = " Select * from Editora ";
		try {
			List<Fornecedor> editoras = new ArrayList<Fornecedor>();
			PreparedStatement stmt = connection.prepareStatement(sql);
